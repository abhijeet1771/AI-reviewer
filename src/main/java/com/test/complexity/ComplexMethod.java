package com.test.complexity;

import java.util.List;
import java.util.ArrayList;

/**
 * High Complexity Method - Should be detected as hotspot
 */
public class DataProcessor {
    
    // This method has high cyclomatic complexity
    public void processComplexData(List<String> data, int threshold, boolean validate) {
        if (data == null) {
            return;
        }
